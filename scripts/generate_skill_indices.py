...
1. Plugin Level (e.g. plugins/common-tools/index.json)
2. Skills Directory Level (e.g. plugins/common-tools/skills/index.json)
3. Individual Skill Level (e.g. plugins/common-tools/skills/gitignore/index.json)
