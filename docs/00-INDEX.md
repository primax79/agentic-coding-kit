# Documentation Index — agentic-coding-kit

## Table of Contents

| Document | Domain & Focus | Primary Audience |
| --- | --- | --- |
...
- **New to Claude Code / Kilo Code plugin concepts?** Start with [`01-concepts.md`](01-concepts.md).
- **Want to create your own skill, agent, plugin, or marketplace?** Read [`02-authoring-and-maintenance.md`](02-authoring-and-maintenance.md).
- **Just want to install or update this kit?** Read [`03-compatibility-and-distribution.md`](03-compatibility-and-distribution.md), or the root [`README.md`](../README.md) for the short version.
